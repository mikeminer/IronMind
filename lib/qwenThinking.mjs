...
export function usesQwen3Thinking(model) {
...
export function addQwen3ThinkingDirective(payload = {}, fallbackModel = "") {
  const model = payload.model || fallbackModel;
  if (!usesQwen3Thinking(model) || !Array.isArray(payload.messages)) return payload;
