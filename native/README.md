...
`ironmind_gguf.c` now owns a bounded raw-tensor residency cache: small high-frequency tensors can be pinned, eligible quantized tensors are kept under an LRU budget, and large tensors stay file-backed with chunked sequential reads.
